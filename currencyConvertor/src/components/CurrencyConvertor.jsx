...
const CurrencyConvertor = () => {
  ...
  return (
    <div className="max-w-xl mx-auto my-10 p-5 bg-white rounded-lg shadow-md">
      <h2 className="mb-5 text-2xl font-semibold text-gray-600">Currency Convertor</h2>
      ...
      <div className="mt-4">
        ...
        <input 
          ...
          type="number" 
          className="w-full p-2 border border-gray-300 rounded-md shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-400 mt-1" />
      </div>
      ...
      {convertedAmount && (<div className="mt-4 text-lg font-medium text-center text-green-600">Converted Amount : {convertedAmount}</div>)}
    </div>
  );
};
