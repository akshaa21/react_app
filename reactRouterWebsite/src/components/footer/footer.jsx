            ...
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    ...
                    <Link to="/" className="flex items-center">
                        ...
                        <h2 className="ml-2 font-medium text-4xl text-gray-700 ">React</h2>
                    </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="text-gray-500 font-medium">
                                <li className="mb-4">
                                    <a
                                        href="https://github.com/akshaa21"
                                ...
                                <li>
                                    <a
                                        href="https://www.linkedin.com/in/ayushi-kulshrestha-81482b239"
                                        className="hover:underline"
                                        target="_blank"
                                        rel="noreferrer"
                                    >
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-5 sm:justify-center sm:mt-0">
                        <Link to="https://www.facebook.com/profile.php?id=100069495338986&mibextid=ZbWKwL" className="text-gray-500 hover:text-gray-900">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                        ...
                        <Link to="https://twitter.com/AyushiKulshre19?t=_gykt5UyFRze3DpW-FGrVg&s=09"
                        ...
                        <Link to="https://github.com/akshaa21" className="text-gray-500">
                            <svg
                                className="w-4 h-4"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <Link to="https://www.linkedin.com/in/ayushi-kulshrestha-81482b239"
                                 className="text-gray-500">
                        <svg 
                            xmlns="http://www.w3.org/2000/svg" 
                            width="16" 
